		...
		<div>
			...
			<div>
				<div className='flex   max-w-7xl flex-grow flex-col items-center justify-center  bg-gray-300  dark:bg-gray-700 '>
					<h1 className='text-bold mx-auto my-4 text-center text-2xl   dark:text-orange-400 sm:text-5xl'>
				...
				<section className='columns-1 gap-6 p-5 sm:columns-2 '>
					<article className='bg-grey-200 prose text-black dark:text-gray-200'>
						...
						<p>
							...
							but also other document type DBs such as DynamoDB or key:value
							stores such as Redis. IoT data collection is typically time based
							so time series DBs will be explored.
						</p>
						<p>
