...
export default function Home() {
	return (
		<>
			...
			<div className='flex flex-grow flex-col items-center justify-center  dark:bg-gray-700 dark:text-gray-200'>
				<h1 className='text-bold mx-auto my-4 text-center text-4xl font-bold text-gray-50 sm:text-lg'>
					Hello Cosmos!
				</h1>
				<section className='columns-1 gap-6 p-5 sm:columns-2 md:columns-3'>
